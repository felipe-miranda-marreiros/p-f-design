...
export const StyledGlobalOverlay = styled(Box)(
	({ theme }: { theme: Theme }) => ({
		display: "flex",
		alignItems: "center",
...
export const StyledMorphRing = styled("span")(
	({ theme }: { theme: Theme }) => ({
		position: "absolute",
		inset: 0,
		borderRadius: "50%",
...
export const StyledCenterDot = styled("span")(
	({ theme }: { theme: Theme }) => ({
		position: "absolute",
		top: "50%",
		left: "50%",
...
export const StyledMfeBlock = styled("span")(({ theme }: { theme: Theme }) => ({
	width: 24,
	height: 24,
	borderRadius: 6,
...
export const StyledMfeLineTrack = styled(Box)(
	({ theme }: { theme: Theme }) => ({
		width: 140,
		height: 2,
...
export const StyledMfeLineFill = styled("span")(
	({ theme }: { theme: Theme }) => ({
		display: "block",
		height: "100%",
...
export const StyledShimmerBox = styled(Box)(({ theme }: { theme: Theme }) => ({
	borderRadius: 6,
	position: "relative",
	overflow: "hidden",
	backgroundColor: theme.palette.grey[100],
...
export const StyledWaveBar = styled("span")(({ theme }: { theme: Theme }) => ({
	width: 4,
	height: 32,
	borderRadius: 4,
...
export const StyledTypingDot = styled("span")(
	({ theme }: { theme: Theme }) => ({
		width: 4,
		height: 4,
		borderRadius: "50%",
...
export const StyledCoinBar = styled("span")(({ theme }: { theme: Theme }) => ({
	width: 14,
...
export const StyledBreathDot = styled("span")(
	({ theme }: { theme: Theme }) => ({
		width: 10,
		height: 10,
		borderRadius: "50%",
...
export const StyledPageSkeletonSidebar = styled(Box)(
	({ theme }: { theme: Theme }) => ({
		width: 72,
...
export const StyledPageSkeletonContent = styled(Box)(
	({ theme }: { theme: Theme }) => ({
		flex: 1,
